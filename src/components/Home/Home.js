    ...
    return (
        <div className='container px-4 md:px-8 xl:px-0 mx-auto max-w-screen-xl'>
            <div className="card w-full bg-base-100 shadow-xl image-full max-h-[50vh]">
                ...
                <div className="card-body max-h-[50vh] text-center">
                    <h2 className="text-4xl font-bold text-white">BRIGHT FORT</h2>
                    <p className='text-xl font-medium md:py-8 p-4 md:px-20 text-white'>Social Learning Community – Explore, Learn, and Improve your skills with Bright Fort. Through this online learning medium, now everyone has the chance to learn!</p>
                    <Link to='/courses'>
