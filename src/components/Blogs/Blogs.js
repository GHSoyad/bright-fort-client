    ...
    return (
        <div className='container px-2 md:px-4 xl:px-0 mx-auto max-w-screen-xl'>
            ...
            <div className='grid md:grid-cols-2 my-10 gap-5 lg:gap-8'>
                <div className='flex flex-col gap-6 bg-primary/30 p-8 rounded-xl justify-between text-lg'>
                ...
                <div className='flex flex-col gap-6 bg-primary/30 p-8 rounded-xl justify-between text-lg'>
                    <div className='flex flex-col gap-5'>
                        ...
                        <p className='text-justify'>
                            Firebase is a set of hosting services for any type of application. It offers NoSQL and real-time hosting of databases, content, social authentication, and notifications, or services, such as a real-time communication server. I am using firebase primarily for user authentication and hosting, It provides an easy and secure way to authenticate users for my web app.
                ...
                <div className='flex flex-col gap-6 bg-primary/30 p-8 rounded-xl justify-between text-lg'>
                    <div className='flex flex-col gap-5'>
                        ...
                        <p className='text-justify'>
                            The private route component is similar to the public route, the only difference is that redirect URL and authenticate condition. If the user is not authenticated they will be redirected to the login page and the user can only access the authenticated routes If they are authenticated (Logged in).
                        </p>
                    </div>
                    <div className='flex items-center gap-10 font-medium'>
                        <div className='flex gap-3 items-center'>
