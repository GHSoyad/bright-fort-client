...
const Checkout = () => {
    ...
    return (
        <div className='container px-2 md:px-4 xl:px-0 mx-auto max-w-screen-xl min-h-[calc(100vh_-_380px)] text-center'>
            <div className='flex flex-col gap-6 p-14 backdrop-blur-sm bg-emerald-900/40 rounded-xl'>
                <h1 className='text-3xl text-primary font-medium'>Congratulations!</h1>
                <h3 className='text-xl text-primary font-medium'>{userInfo.displayName || userInfo.email}</h3>
